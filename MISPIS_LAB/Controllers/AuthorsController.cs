...
namespace MISPIS_LAB.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Position")] Author author)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Position")] Author author)
        {
            if (id != author.ID)
            {
                return NotFound();
